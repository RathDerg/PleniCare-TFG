...
<body>
    <!--------------------------------------------------------------------------------------------------- HEADER -->
    <?php /* <- QUITAR UNA VEZ SE HAGA EL LOG IN
        if($_SESSION("tipo")=="paciente"){
            include_once("header_paciente.php");
        }else {
            include_once("header_medico.php");
        }*/
    ?>
    <main class="container">
                        ...
                        while($tupla = $sql -> fetch()){
                            echo "<article class=\"card col-md-4 col-sm-6 col-12 mb-3 mx-3\" style=\"max-width: 18rem; background-color:rgb(31, 120, 140);\">
                                    ...
                                    <div class=\"card-body text-center\">
                                        ...
                                        <p class=\"card-text \">".$tupla["nombre_completo"]."</p>
                                        <p class=\"card-text\">".$tupla["especialidad"]."</p>
                                    </div>
        ...
        <section class="d-flex justify-content-center">
            <button type="button" class="btn btn-primary" id="btnMSolicitar" data-bs-toggle="modal" data-bs-target="#modalSolicitar">
                Solicitar Cita
            </button>
        </section>
